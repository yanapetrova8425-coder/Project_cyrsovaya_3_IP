-- Полная база данных для салона красоты Neonka
-- Содержит все таблицы: services, masters, bookings, reviews, users
...
-- Таблица для хранения информации о мастерах и их специализациях
-- --------------------------------------------------------
